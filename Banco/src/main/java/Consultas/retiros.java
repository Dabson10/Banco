...
public class retiros {
     public void retiro(JTextField monto,JTextField noCuenta,JTextField clave){
        ...
        PreparedStatement ps = null;
            ...
            String res = "SELECT noCuenta,clave,saldo FROM banco.cuentasusuarios WHERE noCuenta=? AND clave=?;";
            
            ps=conexion.establecerConexion().prepareStatement(res);
            ...
            if(rs.next()){
                ...
                if(monto1>saldo){
                     JOptionPane.showMessageDialog(null, "No tiene suficiente saldo, ingrese aceptable ");
                     
                }else if(saldo>=monto1){
